...
# 2017
Prompt_ll          = LumiList('/afs/cern.ch/cms/CAF/CMSCOMM/COMM_DQM/certification/Collisions17/13TeV/ReReco/Cert_294927-306462_13TeV_EOY2017ReReco_Collisions17_JSON.txt')
PromptMuonsOnly_ll = LumiList('/afs/cern.ch/cms/CAF/CMSCOMM/COMM_DQM/certification/Collisions17/13TeV/ReReco/Cert_294927-306462_13TeV_EOY2017ReReco_Collisions17_JSON_MuonPhys.txt')
...
if __name__ == '__main__':
    ...
    if 'write' in sys.argv:
        Run2018MuonsOnly_ll.writeJSON('Run2017MuonsOnly.json')
        #Run2018_ll.writeJSON('Run2017.json')
