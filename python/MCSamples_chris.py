...
class sample(object):
    def __init__(self, name, nice_name, dataset, nevents, color, syst_frac, cross_section, cross_section_uncert=0.0, k_factor=1, frac_neg_weight=0.0, filenames=None, scheduler='condor', hlt_process_name='HLT', ana_dataset=None, is_madgraph=False, is_zprime=False):
        ...
        # this one is sum of weights
        self.nevents_eff = self.nevents * (1-2*self.frac_neg_weight)
...
#    sample('DYJetsToLL_HT_100to200','DYJetsToLL_HT_100to200','/DYJetsToLL_M-50_HT-100to200_TuneCP5_PSweights_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM',6353263,70,1.,174.0), # in production
#    sample('DYJetsToLL_HT_200to400','DYJetsToLL_HT_200to400','/DYJetsToLL_M-50_HT-200to400_TuneCP5_PSweights_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v2/MINIAODSIM',11225887,70,1.,53.27),
#    sample('DYJetsToLL_HT_400to600','DYJetsToLL_HT_400to600','/DYJetsToLL_M-50_HT-400to600_TuneCP5_PSweights_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15_ext2-v3/MINIAODSIM',9358053,70,1.,7.79),
#    sample('DYJetsToLL_HT_600to800','DYJetsToLL_HT_600to800','/DYJetsToLL_M-50_HT-600to800_TuneCP5_PSweights_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v2/MINIAODSIM',8862104,70,1.,1.882),
#    sample('DYJetsToLL_HT_800to1200','DYJetsToLL_HT_800to1200','/DYJetsToLL_M-50_HT-800to1200_TuneCP5_PSweights_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v2/MINIAODSIM',3138129,70,1.,0.8729),
#    sample('DYJetsToLL_HT_1200to2500','DYJetsToLL_HT_1200to2500','/DYJetsToLL_M-50_HT-1200to2500_TuneCP5_PSweights_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v2/MINIAODSIM',536416,70,1.,0.2079), # in production
#    sample('DYJetsToLL_HT_2500toInf','DYJetsToLL_HT-2500toInf','/DYJetsToLL_M-50_HT-2500toInf_TuneCP5_PSweights_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v2/MINIAODSIM',427051,70,1.,0.003765),
    ...
    # combined
    sample('tbarW_full', 'tbarW', None, 8000000+7623000, 63 , 1., 34.97, k_factor=1., cross_section_uncert=0.02827, frac_neg_weight=0.0034),
    sample('tW_full', 'tW', None, 9438000+6952830, 66 , 1., 34.91, k_factor=1., cross_section_uncert=0.02817, frac_neg_weight=0.003758),
...
# ### 	N_EVENT scaled by: -N_EVENT * n_neg/n + n * n_pos/n (N_EVENT from report = 28968252; n from weight = 9112991 n_neg = 1507200 (0.1654); n_pos = 7605790 (0.8346); )
    ...
    #sample('dyInclusive50_amcatnlo', 'DYInclusive50', '/DYJetsToLL_M-50_TuneCP5_13TeV-amcatnloFXFX-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 997561, 209 , 1., 6529.0, k_factor=1., is_madgraph=True, cross_section_uncert=28.29, frac_neg_weight=0.1624),  
 	...
 	#sample('dyInclusive50_madgraph', 'DYInclusive50', '/DYJetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 100194597, 209 , 1., 6225.42/3, k_factor=1., is_madgraph=True, cross_section_uncert=12.64, frac_neg_weight=0.0004962), # NNLO XS is 6225.42 and has fractional uncertainty of 2% see 
...
samples17 = [
    ...
    #sample('WWinclusive', 'WWinclusive', '/WWTo2L2Nu_NNPDF31_TuneCP5_13TeV-powheg-pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v1/MINIAODSIM', 2000000, 208, 1., 12.178, k_factor=1.), # Need XS
    #sample('WWinclusive_ext', 'WWinclusive', '/WWTo2L2Nu_NNPDF31_TuneCP5_PSweights_13TeV-powheg-pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14_ext1-v1/MINIAODSIM', 2000000, 208, 1., 11.08, k_factor=1.),
    #sample('WW200to600', 'WW200to600', '', 200000, 208, 1., 1.385, k_factor=1.), # Need XS and sample to finish
    #sample('WW600to1200', 'WW600to1200', '/WWTo2L2Nu_MLL_600To1200_v2_NNPDF31_13TeV-powheg/RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v1/MINIAODSIM', 1017984, 208, 1., 0.0566, k_factor=1.), # Need XS
    #sample('WW1200to2500', 'WW1200to2500', '/WWTo2L2Nu_MLL_1200To2500_NNPDF31_13TeV-powheg/RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v1/MINIAODSIM', 166261, 208, 1., 0.003557, k_factor=1.), # Need XS
    #sample('WW2500', 'WW2500','/WWTo2L2Nu_MLL_2500ToInf_NNPDF31_13TeV-powheg/RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v1/MINIAODSIM', 2495, 208, 1., 0.00005395, k_factor=1.), # Need XS
    ...
    # Single-Top
 	sample('tbarW', 'tbarW', '/ST_tW_antitop_5f_NoFullyHadronicDecays_TuneCP5_13TeV-powheg-pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_new_pmx_94X_mc2017_realistic_v14-v1/MINIAODSIM', 5635539, 63 , 1., 34.97, k_factor=1., cross_section_uncert=0.02827, frac_neg_weight=0.0034),
    sample('tW', 'tW', '/ST_tW_top_5f_NoFullyHadronicDecays_TuneCP5_13TeV-powheg-pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_new_pmx_94X_mc2017_realistic_v14-v1/MINIAODSIM', 4955102, 66 , 1., 34.91, k_factor=1., cross_section_uncert=0.02817, frac_neg_weight=0.003758),
...
# ### 	N_EVENT scaled by: -N_EVENT * n_neg/n + n * n_pos/n (N_EVENT from report = 28968252; n from weight = 9112991 n_neg = 1507200 (0.1654); n_pos = 7605790 (0.8346); )
    ...
    # DYJetsToLL - in the past we've used amcatnloFXFX but why?
    sample('dyInclusive50_amcatnlo', 'DYInclusive50', '/DYJetsToLL_M-50_TuneCP5_13TeV-amcatnloFXFX-pythia8/RunIIFall17MiniAODv2-MUOTrackFix_12Apr2018_94X_mc2017_realistic_v14_ext2-v1/MINIAODSIM', 8875401, 209 , 1., 6529.0/3., k_factor=1., is_madgraph=True, cross_section_uncert=28.29, frac_neg_weight=0.1624),  
 	#sample('dyInclusive50_madgraph', 'DYInclusive50', '/DYJetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM', 100194597, 209 , 1., 5343.0, k_factor=1., is_madgraph=True, cross_section_uncert=12.64, frac_neg_weight=0.0004962), # NNLO XS is 6225.42 and has fractional uncertainty of 2% see 
    # https://indico.cern.ch/event/746829/contributions/3138541/attachments/1717905/2772129/Drell-Yan_jets_crosssection.pdf
...
__all__ = ['samples'] + [s.name for s in samples18+samples17]
