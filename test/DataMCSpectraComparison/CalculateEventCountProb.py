...
parser.add_argument('-c','--cut',dest='cut',help='Selection criteria, e.g. vertex_m>2000')
parser.add_argument('-d','--dir',dest='dir',default='Our2018MuonsOppSignNtuple',help='Ntuple type')
