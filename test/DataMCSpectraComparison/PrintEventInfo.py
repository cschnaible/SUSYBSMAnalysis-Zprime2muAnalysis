...
parser.add_argument('-d','--data',default='data/ana_datamc_Run2018ABC_17Sep2018_Run2018D_22Jan2019.root')
...
t = data.Our2018MuonsOppSignNtuple.Get('t')
...
toPrintMu = 'lep_id[X]:lep_pt[X]:lep_pt_err[X]:lep_eta[X]:lep_phi[X]'
